// <copyright file="ProductService.cs" company="marcos software">
...
namespace AppLicenseserver.Domain.Service
{
	...
	public class ProductService<Tv, Te> : GenericService<Tv, Te>
		...
		where Te : Product
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ProductService{Tv, Te}"/> class.
		/// </summary>
