// <copyright file="TelemetryService.cs" company="marcos software">
...
namespace AppLicenseserver.Domain.Service
{
	...
	public class TelemetryService<Tv, Te> : GenericService<Tv, Te>
		...
		where Te : Telemetry
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TelemetryService{Tv, Te}"/> class.
		/// </summary>
